...
void setup() {
  FastLED.addLeds<APA102, STRAND_1_DATA_PIN, STRAND_1_CLOCK_PIN, BGR>(strand1, STRAND_1_PIXELS);
  FastLED.addLeds<APA102, STRAND_2_DATA_PIN, STRAND_2_CLOCK_PIN, BGR>(strand2, STRAND_2_PIXELS);
  FastLED.addLeds<APA102, STRAND_3_DATA_PIN, STRAND_3_CLOCK_PIN, BGR>(strand3, STRAND_3_PIXELS);
  FastLED.addLeds<APA102, STRAND_4_DATA_PIN, STRAND_4_CLOCK_PIN, BGR>(strand4, STRAND_4_PIXELS);
