...
#define STRAND_3_FRACTIONAL_PIXELS ((STRAND_3_PIXELS) * (FRACTIONAL_BRIGHTNESS - 1))
#define STRAND_4_FRACTIONAL_PIXELS ((STRAND_4_PIXELS) * (FRACTIONAL_BRIGHTNESS - 1))
#define STRAND_5_FRACTIONAL_PIXELS ((STRAND_5_PIXELS) * (FRACTIONAL_BRIGHTNESS - 1))
#define STRAND_6_FRACTIONAL_PIXELS ((STRAND_6_PIXELS) * (FRACTIONAL_BRIGHTNESS - 1))
